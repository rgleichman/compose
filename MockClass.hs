...
data AMet_aa = AMet_aa

instance Match AMet_aa Method (a -> a)
...
--applyTwice :: (App ADef w b String, App Aa_a w b b, Show b, Num b) => w b -> String
--applyTwice :: (Show b, Num b) => w b -> String
--applyTwice :: (App Aa_a w b b, Show b, Num b) => w b -> String
--applyTwice :: (App Aa_a w b b, App ADef w b String, Show b, Num b) => w b -> String
applyTwice :: (App Aa_a w b String, App Aa_a w b b, Show b, Num b) => w b -> String
applyTwice x = unwrap (wApply Aa_a show x) ++ (show . unwrap $ wApply Aa_a (+1) x)
